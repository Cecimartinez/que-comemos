export const StarIcons = Array(5).fill(
  <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-star-filled" width="20" height="20" viewBox="0 0 24 24"  stroke="currentColor" fill="none" >
