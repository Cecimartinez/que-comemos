...
export const Login = () => {
  return (
    <div className="bg-white font-poppins flex flex-col justify-center items-baseline h-full  w-full ">
      ...
      <div className="bg-white px-10 py-8 my-4 w-full h-full  md:justify-center md:px-60 md:my-8">
        <LoginForm />
      </div>
    </div>
  );
